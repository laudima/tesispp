\begin{frame}{Introduction}
  This is a customization of the CleanEasy Beamer theme for its usage in the contents of the 1st International Conference on Philosophy of Computing, so most of the examples are taken from the original source.
...
\begin{frame}{Block environments}
  ...
  \begin{theorem}
    In a triangle with a right angle, the square of the hypotenuse is equal to the sum of squares of the other two sides.
  \end{theorem}
